        ...
        try{
            ...
            if(contact.length < 10){
                await Swal.fire({
                    icon: 'error',
                    title: 'Oops...',
                    text: 'Contact must be at least 10 characters!'
                })
            }
            ...
            <div className={classes.paper}>
                ...
                <form onSubmit={register} className={classes.form}>
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} sm={6}>
                            <TextField id="contact" name="contact" label="Contact Number" variant="outlined" fullWidth required
                                       type="text"
                        ...
                        <Grid item xs={12} sm={6}>
                            <TextField id="university" name="university" label="University or Institute" variant="outlined" fullWidth required
                                       type="text"
                    ...
                    <Grid container justify="center">
                        <Grid item>
                            <a href="/attendeelogin" variant="body2" className="nav-link" style={{textDecoration: 'none'}}>
